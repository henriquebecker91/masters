...
The authors found redudant to present weakly correlated datasets in addition to the strongly correlated datasets, as preliminary results suggested that the time spent weakly correlated datasets was similar to the time spent solving strongly correlated datasets of smaller size.
