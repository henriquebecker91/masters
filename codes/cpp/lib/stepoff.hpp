#ifndef HBM_ORDERED_STEP_OFF_HPP
#define HBM_ORDERED_STEP_OFF_HPP
...
namespace hbm {
  ...
  namespace hbm_ordered_step_off_impl {
    using namespace std;
    ...
    struct ordered_step_off_wrap : wrapper_t<W, P, I> {
      virtual void operator()(instance_t<W, P> &ukpi, solution_t<W, P, I> &sol, bool already_sorted) const {
        ...
        hbm_ordered_step_off_impl::ordered_step_off(ukpi, sol, already_sorted);
  ...
  void ordered_step_off(instance_t<W, P> &ukpi, solution_t<W, P, I> &sol, int argc, argv_t argv) {
    hbm_ordered_step_off_impl::ordered_step_off(ukpi, sol, argc, argv);
  }
}

#endif //HBM_ORDERED_STEP_OFF_HPP
