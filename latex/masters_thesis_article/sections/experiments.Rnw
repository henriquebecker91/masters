...
The authors selected the emphases they deemed more adequate, and this experiment with all of them.
...
Even only considering the finished and correct runs of both solvers, CPLEX mean time was 56 seconds while Gurobi mean time was 95 seconds
...
MTU1 is not shown because its results are similar but dominated by MTU2, the same applies to TSO and OSO.
...
mtu1_times$alg <- 'MTU1'
ordso_times$alg <- 'OSO (weight, integer)' # TODO: check this at end
