...
Such results bring up two central questions the authors address: 1) Why the TSO was abandoned and not considered in recent comparisons? How the TSO outperformed the current state-of-the-art after five decades of study of the UKP?

The authors believe the TSO was not considered in recent comparisons because: 1) CONTINUE HERE (old terminology and limited comparisons)
