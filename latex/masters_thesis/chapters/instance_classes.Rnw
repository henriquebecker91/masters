...
csv <- read.csv("../data/cutstock_knap_solvers.csv", sep = ";")
csv$X <- NULL
...
# who doesn't.
csv_no_na <- csv
csv_no_na[is.na(csv$hex_sum_knapsack_time), ]$hex_sum_knapsack_time <- 600
...
master_time <- csv
master_time[is.na(csv$hex_sum_knapsack_time), ]$hex_sum_knapsack_time <- 600
master_time[is.na(csv$hex_sum_master_prob_time), ]$hex_sum_master_prob_time <- 600
#csv_no_na <- csv[!is.na(csv$hex_sum_knapsack_time), ]
...
corr_time <- csv[complete.cases(csv),]
...
compare_num_iter(csv, 'ukp5_int_cutstock', 'ukp5_int_ns_cutstock') +
  geom_point()
@
\end{center}
\legend{Source: the author.}
...
compare_num_iter(csv, 'ukp5_fp_cutstock', 'ukp5_fp_ns_cutstock') +
  geom_point()
@
\end{center}
\legend{Source: the author.}
...
compare_num_iter(csv, 'ukp5_fp_ns_cutstock', 'ukp5_int_ns_cutstock') +
  geom_point()
@
\end{center}
\legend{Source: the author.}
...
compare_num_iter(csv, 'ukp5_fp_cutstock', 'ukp5_int_cutstock') +
  geom_point()
@
\end{center}
\legend{Source: the author.}
