...
// Execute the `terminating step-off' algorithm presented in "The theory and
...
int main(int argc, char** argv) {
  ...
  return hbm::benchmark_pyasukp<size_t, size_t, size_t>(&hbm::terminating_step_off, argc, argv);
}
