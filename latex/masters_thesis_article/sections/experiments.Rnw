...
gen_graph_all_alg_discrete_x <- function(csv) {
  ...
  p <- ggplot(csv,
    ...
    scale_shape_manual(name = "Algorithm",
                       #labels = c('cpp-mtu1' = 'cpp-mtu1', 'cpp-mtu2' = 'cpp-mtu2', 'eduk' = 'eduk', 'eduk2' = 'eduk2', 'ordered_step_off' = 'ordered_step_off', 'terminating_step_off' = 'terminating_step_off', 'mgreendp' = 'mgreendp'),
...
breq_csv$n <- sapply(breq_csv$filename, breq_get_n)
