...
The indexes of the items in the solutions of the pricing problems are remapped to their original values before returning the solution to the master problem.
