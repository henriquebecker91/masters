...
#include "ukp_types.hpp"
      ...
      #endif
      #define HBM_EFF_TYPE HBM_INT_EFF_TYPE
    #endif /*HBM_INT_EFF*/
  #else /*HBM_FP_EFF*/
    #ifdef HBM_TWO_MULT_COMP
    ...
    #endif
    #define HBM_EFF_TYPE HBM_FP_EFF_TYPE
  #endif /*HBM_FP_EFF*/
  ...
  #endif
  #define HBM_EFF_TYPE HBM_RATIONAL_EFF_TYPE
...
struct item_t {
  ...
  inline item_t(size_t w, size_t p) : w(w), p(p) {
    efficiency = ((HBM_EFF_TYPE)p) / ((HBM_EFF_TYPE)w);
  }
  #endif
