...
\draw [] (10, 10) circle [radius=\myrad];
\node [above left, font=\tiny] at (10, 10) {(10, 10)};
\draw [dashed] (10, 0) -- (10, 10) -- (25, 10);

\draw [] (15, 15) circle [radius=\myrad];
\node [above left, font=\tiny] at (15, 15) {(15, 15)};
\draw [dashed] (15, 0) -- (15, 15) -- (25, 15);

%\draw [] (20, 20) circle [radius=\myrad];
%\node [above left, font=\tiny] at (20, 20) {(20, 20)};

\draw [] (0,0) -- (15,15);

\draw [fill] (7, 2) circle [radius=\myrad];
\draw [gray, fill] (11, 4) circle [radius=\myrad];
%\node [below right, font=\tiny] at (11, 4) {(11, 4)};
\draw [gray, fill] (12, 9) circle [radius=\myrad];
%\node [below right, font=\tiny] at (12, 9) {(12, 9)};
\draw [fill] (14, 11) circle [radius=\myrad];
\draw [gray, fill] (16, 13) circle [radius=\myrad];
%\node [below right, font=\tiny] at (16, 13) {(16, 13)};
...
\draw [fill] (3, 2) circle [radius=\myrad];
\node [below right, font=\tiny] at (3, 2) {(3, 2)};
\draw [] (0,0) -- (3,2);
...
\draw [] (13, 12) circle [radius=\myrad];
...
\draw [fill] (11, 4) circle [radius=\myrad];
\draw [fill] (12, 9) circle [radius=\myrad];
\draw [gray, fill] (14, 11) circle [radius=\myrad];
\draw [fill] (16, 13) circle [radius=\myrad];
\draw [fill] (17, 21) circle [radius=\myrad];
...
\draw [gray] (6, 4) circle [radius=\myrad];
\draw [dashed] (5, 0) -- (5, 5) -- (25, 5);
\draw [] (0,0) -- (6,4);
...
\draw [gray] (20, 20) circle [radius=\myrad];
