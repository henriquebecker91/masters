...
Only implementations including the tiebreaker improvement were used in the experiments, thus, for simplicity, the R-OSO, R-TSO and R-Green will be referred as OSO, TSO and Green in this section.
...
In this version Green is considered, UKP5 is replaced by the Terminating Step-Off (TSO), and all runs were executed serially.
